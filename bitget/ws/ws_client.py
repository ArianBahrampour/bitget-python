...
from bitget.utils.consts import GET, REQUEST_PATH
from bitget.utils.ws_hash import check_none, pre_hash, sign_secret
...
class BitgetWsClient:
    ...
    def __login(self):
        check_none(self.__api_key, "api key")
        check_none(self.__api_secret_key, "api secret key")
        check_none(self.__passphrase, "passphrase")
        timestamp = int(round(time.time()))
        sign = sign_secret(pre_hash(timestamp, GET, REQUEST_PATH), self.__api_secret_key)
